...
class CouplingAndPotential
{
  public:
    ...
    //! GRChombo argument order: (dfdphi, d2fdphi2, g2, dg2dphi, V_of_phi,
    //! dVdphi)
    template <class data_t, template <typename> class vars_t>
    void compute_coupling_and_potential(
        data_t &dfdphi, data_t &d2fdphi2, data_t &g2, data_t &dg2dphi,
        data_t &V_of_phi, data_t &dVdphi, const vars_t<data_t> & /*vars*/,
